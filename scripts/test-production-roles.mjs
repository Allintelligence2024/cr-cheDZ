...
run(process.execPath, ['--test', 'tests/tenant-isolation/ci-notice-budget.test.mjs', 'tests/tenant-isolation/registry-pull.test.mjs', 'tests/tenant-isolation/dev-compose-contract.test.mjs', 'tests/tenant-isolation/dev-proxy.test.mjs', 'tests/tenant-isolation/openapi-contract.test.mjs', 'tests/tenant-isolation/client-leak-guard.test.mjs', 'tests/tenant-isolation/on-conflict-targets.test.mjs', 'tests/tenant-isolation/edge-headers-contract.test.mjs', 'tests/tenant-isolation/media-client-wiring.test.mjs', 'tests/tenant-isolation/parent-session-contract.test.mjs']);
...
console.log('✓ GATE D : régressions Phase D + 59 suites/contrôles (E1–E6 incluses) avec rôles et grants de production.');
