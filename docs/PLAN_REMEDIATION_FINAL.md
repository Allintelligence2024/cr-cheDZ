...
| **S4** | **Charge sur cible réelle** | `tests/load/sync.k6.js` + `capacity-bench.mjs` (**208 L réels**, pas 13 307) sur la cible VPS ; documenter les cibles de capacité (staff simultané par crèche, pics de sync). | 1 j |
