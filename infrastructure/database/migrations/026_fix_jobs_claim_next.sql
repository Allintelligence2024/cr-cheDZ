-- ============================================================================
-- 026_fix_jobs_claim_next.sql
-- Correction de jobs_claim_next() (migration 024) : « column reference
-- attempts is ambiguous » — les colonnes OUT (attempts, max_attempts)
-- entraient en collision avec les colonnes de background_jobs dans le WHERE.
-- CREATE OR REPLACE : aucune migration existante n'est modifiée (ADR-007).
-- ============================================================================
