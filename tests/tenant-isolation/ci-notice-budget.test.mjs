...
test('strict gate budgets notices for H1/F2/F4 and aggregates every H2 count', () => {
  ...
  for (const [lot, counter] of Object.entries({ H2a: 'confidentiality', H2b: 'revocation', H2c: 'parentAccess', H2d: 'financialProjection', H2e: 'journalHealth', H2f: 'privacyActor', H2g: 'photoConsent' })) {
